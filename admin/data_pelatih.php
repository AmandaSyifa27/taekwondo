                ...
                <i class="fas fa-sync"></i>
                  ...
                  <table class="table align-items-center table-flush" id="dataTable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>
                            <input type="checkbox" name="id_pelatih[]" value="<?= $data['id_pelatih']?>" >
                        </td>
                        <td><?= $i++; ?></td>
                        <td><img src="foto_pelatih/<?= $data['foto'] ?>" alt="Foto Pelatih" width="100px"></td>
                        <td><?= $data["nama_pelatih"] ?></td>
                        <td><?= $data["jabatan"] ?></td>
                        <td><img src="../foto_sabuk/<?= $data['warna'] ?>" width="100px" alt="<?= $data['tingkatan'] ?>"></td>
                        <td><a href="index.php?page=edit_pelatih&id=<?= $data['id_pelatih'] ?>" class="btn btn-outline-warning mb-1">Edit</a><br>
                        <a onclick="return confirm('Apakah anda ingin menghapus data?')" href="index.php?page=delete_pelatih&id=<?= $data['id_pelatih'] ?>" class="btn btn-outline-danger mb-1">Hapus</a>
                        </td>
                      </tr>
                      <?php endwhile;?>
                    </tbody>
