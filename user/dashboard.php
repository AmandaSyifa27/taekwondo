<div class="row mb-3">
                ...
                <div class="row align-items-center">
                    <div class="col mr-2">
                        <div class="row">
                            ...
                            <div class="col">
                                <img width="90%" src="../img/pelatiw.png" alt="Pelatih">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card h-100">
            <a href="index.php?page=add_anggota" class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="row">
                            ...
                            <div class="col">
                                <img width="90%" src="../img/anggota.png" alt="Anggota">
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="row">
    ...
    <div class="col-lg-12">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="chart-area d-flex justify-content-center" style="display: flex;
